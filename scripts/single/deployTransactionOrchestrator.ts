...
async function main() {
  ...
  // Deploy TransactionOrchestrator contract with AddressDiscovery address as constructor argument
  await DeploymentUtils.deployContractWithSigner("TransactionOrchestrator", [addressDiscoveryAddress], deployer);
}
