...
async function main() {
  ...
  // Deploy AssetRegistry contract with AddressDiscovery address as constructor argument
  await DeploymentUtils.deployContractWithSigner("AssetRegistry", [addressDiscoveryAddress], deployer);
}
